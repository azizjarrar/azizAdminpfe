...
class ListSpecialiteComponent extends Component {
    ...
    deleteSpecialite(id){
        this.setState({...this.state,modal:true,idToDelte:id})
    ...
    passmodal=()=>{
        ...
        console.log(this.state.idToDelte)
        SpecialiteService.deleteSpecialite(this.state.idToDelte).then( res => {
            this.setState({"show":true});
            setTimeout(()=> this.setState({"show":false}), 3000);
            this.setState({specialites: this.state.specialites.filter(specialite => specialite.id !== this.state.idToDelte)});
    ...
    const pageNumCss = {
        ...
        return (
            <div class="container">
                {this.state.modal==true&&<div class="Modal">
                    <div className="messageErrorContainer">
                        <p>tu veux supprimer cette specialite</p>
                        <div class="btnsContainer">
                            <div class="btn1"><button onClick={this.passmodal}><p>oui</p></button></div>
                            <div class="btn2"><button onClick={this.closemodal}><p>non</p></button></div>
                        </div>
                    </div>
                </div>}
