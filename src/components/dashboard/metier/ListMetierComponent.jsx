...
class ListMetierComponent extends Component {
    ...
    passmodal=()=>{
        ...
        MetierService.deleteMetier(this.state.idToDelte).then( res => {
            this.setState({"show":true});
            setTimeout(()=> this.setState({"show":false}), 3000);
            this.setState({...this.state,modal:false})

            this.setState({metiers: this.state.metiers.filter(metier => metier.id !== this.state.idToDelte)});
            ...
            <div class="container">
                {this.state.modal==true&&<div class="Modal">
                    <div className="messageErrorContainer">
                        <p>tu veux supprimer cette Metier</p>
