...
class ListFaculteComponent extends Component {
    ...
    passmodal=()=>{
        ...
        FaculteService.deleteFaculte(this.state.idToDelte).then( res => {
            this.setState({"show":true});
            setTimeout(()=> this.setState({"show":false}), 3000);
            this.setState({...this.state,modal:false})

            this.setState({facultes: this.state.facultes.filter(faculte => {return faculte.id != this.state.idToDelte})});
        });
    }
    closemodal=()=>{
        this.setState({...this.state,modal:false})
            ...
            <div class="container">
                {this.state.modal==true&&<div class="Modal">
                    <div className="messageErrorContainer">
                        <p>tu veux supprimer cette faculte</p>
